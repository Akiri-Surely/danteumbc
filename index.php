    ...
    <div class="modal fade" id="helpModal" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <p>On the <b>right</b> side of the screen, when a video is selected, you find a video player with a rating bar and a rating scale to be used. To play the video please click on the video</b>. Moving your cursor along the ratings bar located under the video changes the recorded rating value for the selected emotional dimension (valence/arousal/dominance). The dimensions rate the videos continuously, with each end representing the maximum value. </p>
            <p> Arousal, on the left is “very passive”, the right is “very active”; valence, the left is “very negative” and the right is “very positive”; and dominance, the left is “in control” and the right is “out of control”.<p>
            <p><b>Please note</b>
            <ul>
            ...
            <p>After rating each video please select the <b>communication channels</b> that influenced your ratings from the options provided. Others please type it in the space provided.</p>
            <br> 
