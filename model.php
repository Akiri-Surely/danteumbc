        ...
        static function addAnnotation($data){
            ...
            if ($GLOBALS['save_mode'] == 'db') {
                ...
                if (strpos($type, 'behavior') !== false){
                    ...
                    $stmt->bind_param("sssiiiis", $userId, $video, $type, $data->faceTouch, $data->head,  $data->trunk, $data->arms, $data->legs, $data->wholeBody, $data->voice, $data->others);
                    $stmt->execute();
                ...
                if (strpos($type, 'behavior') !== false){
                    ...
                    fwrite($myfile,"UserId;NameVideo;AnnoType;faceTouch;head;trunk;arms;legs;wholeBody;voice;Others\n");
                    fwrite($myfile, $userId.";".$video.";".$type.";".$data->faceTouch.";".$data->head .";".$data->trunk.";".$data->arms.";".$data->legs.";".$data->wholeBody.";".$data->voice.";".$data->others."\n");
